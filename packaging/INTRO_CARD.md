...
<img src="https://huggingface.co/spaces/TIEdgeAI/README/resolve/main/docs/assets/TXN-Logo.png" alt="Texas Instruments" width="80" height="80" />

# Texas Instruments

### Semiconductor solutions for embedded and edge applications
...
**[Tiny ML ModelZoo →](https://github.com/TexasInstruments/tinyml-modelzoo)** — TI's central repo of AI models, examples & configs for MCU applications; training, quantization & compilation happen automatically on any example config. [tinyml-tensorlab](https://github.com/TexasInstruments/tinyml-tensorlab) adds Python packages, agent skills & tools for the same BYOD/BYOM workflows.
- Time-series classification/regression/forecasting/anomaly detection, plus audio, image & radar point-cloud classification
- Devices: AM13, MSPM0, C2000 (C28/C29 DSP), MSPM33C, AM26x, CC13xx/CC27xx/CC35xx connectivity, IWRL6432 radar — several with a TinyEngine NPU accelerator
- Use cases: Motor & fault diagnostics · Predictive maintenance · Keyword spotting · Presence & fall detection · Grid & power monitoring · Gesture recognition & more

**[Edge AI Studio GUI →](https://www.ti.com/tool/EDGE-AI-STUDIO)** — TI's graphical & command-line tools for MCU AI development, part of the CCStudio™ ecosystem, for both AI-accelerated (TinyEngine™) and non-accelerated MCU devices.
- Model Composer: no-code GUI for data collection, annotation, training & deployment 
- Cloud or desktop app; integrates with the CCStudio™ IDE
